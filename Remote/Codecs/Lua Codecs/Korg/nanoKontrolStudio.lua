...
local items=
 {
  ...
  {name="Button Solo 1", input="button", output="value"},
  {name="Button Solo 2", input="button", output="value"},
  {name="Button Solo 3", input="button", output="value"},
  {name="Button Solo 4", input="button", output="value"},
  {name="Button Solo 5", input="button", output="value"},
  {name="Button Solo 6", input="button", output="value"},
  {name="Button Solo 7", input="button", output="value"},
  {name="Button Solo 8", input="button", output="value"},

  {name="Button Mute 1", input="button", output="value"},
  {name="Button Mute 2", input="button", output="value"},
  {name="Button Mute 3", input="button", output="value"},
  {name="Button Mute 4", input="button", output="value"},
  {name="Button Mute 5", input="button", output="value"},
  {name="Button Mute 6", input="button", output="value"},
  {name="Button Mute 7", input="button", output="value"},
  {name="Button Mute 8", input="button", output="value"},

  {name="Button Rec 1", input="button", output="value"},
  {name="Button Rec 2", input="button", output="value"},
  {name="Button Rec 3", input="button", output="value"},
  {name="Button Rec 4", input="button", output="value"},
  {name="Button Rec 5", input="button", output="value"},
  {name="Button Rec 6", input="button", output="value"},
  {name="Button Rec 7", input="button", output="value"},
  {name="Button Rec 8", input="button", output="value"},

  {name="Button Select 1", input="button", output="value"},
  {name="Button Select 2", input="button", output="value"},
  {name="Button Select 3", input="button", output="value"},
  {name="Button Select 4", input="button", output="value"},
  {name="Button Select 5", input="button", output="value"},
  {name="Button Select 6", input="button", output="value"},
  {name="Button Select 7", input="button", output="value"},
  {name="Button Select 8", input="button", output="value"},
...
local inputs=
 {
  ...
  {pattern="bf 20 xx", name="Button Solo 1", value="x/127"},
  {pattern="bf 21 xx", name="Button Solo 2", value="x/127"},
  {pattern="bf 22 xx", name="Button Solo 3", value="x/127"},
  {pattern="bf 23 xx", name="Button Solo 4", value="x/127"},
  {pattern="bf 24 xx", name="Button Solo 5", value="x/127"},
  {pattern="bf 25 xx", name="Button Solo 6", value="x/127"},
  {pattern="bf 26 xx", name="Button Solo 7", value="x/127"},
  {pattern="bf 27 xx", name="Button Solo 8", value="x/127"},

  {pattern="bf 30 xx", name="Button Mute 1", value="x/127"},
  {pattern="bf 31 xx", name="Button Mute 2", value="x/127"},
  {pattern="bf 32 xx", name="Button Mute 3", value="x/127"},
  {pattern="bf 33 xx", name="Button Mute 4", value="x/127"},
  {pattern="bf 34 xx", name="Button Mute 5", value="x/127"},
  {pattern="bf 35 xx", name="Button Mute 6", value="x/127"},
  {pattern="bf 36 xx", name="Button Mute 7", value="x/127"},
  {pattern="bf 37 xx", name="Button Mute 8", value="x/127"},

  {pattern="bf 40 xx", name="Button Rec 1", value="x/127"},
  {pattern="bf 41 xx", name="Button Rec 2", value="x/127"},
  {pattern="bf 42 xx", name="Button Rec 3", value="x/127"},
  {pattern="bf 43 xx", name="Button Rec 4", value="x/127"},
  {pattern="bf 44 xx", name="Button Rec 5", value="x/127"},
  {pattern="bf 45 xx", name="Button Rec 6", value="x/127"},
  {pattern="bf 46 xx", name="Button Rec 7", value="x/127"},
  {pattern="bf 47 xx", name="Button Rec 8", value="x/127"},

  {pattern="bf 50 xx", name="Button Select 1", value="x/127"},
  {pattern="bf 51 xx", name="Button Select 2", value="x/127"},
  {pattern="bf 52 xx", name="Button Select 3", value="x/127"},
  {pattern="bf 53 xx", name="Button Select 4", value="x/127"},
  {pattern="bf 54 xx", name="Button Select 5", value="x/127"},
  {pattern="bf 55 xx", name="Button Select 6", value="x/127"},
  {pattern="bf 56 xx", name="Button Select 7", value="x/127"},
  {pattern="bf 57 xx", name="Button Select 8", value="x/127"},
}
...
local outputs =
    {
		...
		{name="Button Solo 1", pattern="bf 20 xx", x="127*value"},
		{name="Button Solo 2", pattern="bf 21 xx", x="127*value"},
		{name="Button Solo 3", pattern="bf 22 xx", x="127*value"},
		{name="Button Solo 4", pattern="bf 23 xx", x="127*value"},
		{name="Button Solo 5", pattern="bf 24 xx", x="127*value"},
		{name="Button Solo 6", pattern="bf 25 xx", x="127*value"},
		{name="Button Solo 7", pattern="bf 26 xx", x="127*value"},
		{name="Button Solo 8", pattern="bf 27 xx", x="127*value"},
		
		{name="Button Mute 1", pattern="bf 30 xx", x="127*value"},
		{name="Button Mute 2", pattern="bf 31 xx", x="127*value"},
		{name="Button Mute 3", pattern="bf 32 xx", x="127*value"},
		{name="Button Mute 4", pattern="bf 33 xx", x="127*value"},
		{name="Button Mute 5", pattern="bf 34 xx", x="127*value"},
		{name="Button Mute 6", pattern="bf 35 xx", x="127*value"},
		{name="Button Mute 7", pattern="bf 36 xx", x="127*value"},
		{name="Button Mute 8", pattern="bf 37 xx", x="127*value"},
		
		{name="Button Rec 1", pattern="bf 40 xx", x="127*value"},
		{name="Button Rec 2", pattern="bf 41 xx", x="127*value"},
		{name="Button Rec 3", pattern="bf 42 xx", x="127*value"},
		{name="Button Rec 4", pattern="bf 43 xx", x="127*value"},
		{name="Button Rec 5", pattern="bf 44 xx", x="127*value"},
		{name="Button Rec 6", pattern="bf 45 xx", x="127*value"},
		{name="Button Rec 7", pattern="bf 46 xx", x="127*value"},
		{name="Button Rec 8", pattern="bf 47 xx", x="127*value"},
		
		{name="Button Select 1", pattern="bf 50 xx", x="127*value"},
		{name="Button Select 2", pattern="bf 51 xx", x="127*value"},
		{name="Button Select 3", pattern="bf 52 xx", x="127*value"},
		{name="Button Select 4", pattern="bf 53 xx", x="127*value"},
		{name="Button Select 5", pattern="bf 54 xx", x="127*value"},
		{name="Button Select 6", pattern="bf 55 xx", x="127*value"},
		{name="Button Select 7", pattern="bf 56 xx", x="127*value"},
		{name="Button Select 8", pattern="bf 57 xx", x="127*value"},
	}
